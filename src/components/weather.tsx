...
export function Weather({
  ...
  return (
    <div className={cx("flex flex-col gap-4  p-4 skeleton-bg max-w-[500px]")}>
      <div className="flex flex-col gap-2">
        <div className="flex flex-row gap-3 items-center">
          ...
          <div className="text-4xl font-medium text-gray">
            {n(weatherAtLocation.current.temperature_2m)}
            {weatherAtLocation.current_units.temperature_2m}
          </div>
        </div>

        <div className="text-gray">{`H:${n(currentHigh)}° L:${n(
          currentLow
        )}°`}</div>
      </div>
      ...
      <div className="flex flex-col gap-4">
        {displayTimes.map((time, index) => (
          <div key={time} className="flex flex-row gap-2 items-center">
