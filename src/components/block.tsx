    ...
    <AnimatePresence>
      {block.isVisible && (
        ...
        >
          ...
          >
            <div className="p-2 sm:p-4 flex flex-row justify-between items-center gap-2 border-b border-border/40 shrink-0">
              <div className="flex flex-row gap-2 sm:gap-4 items-center min-w-0">
                <BlockCloseButton />
            ...
            <div
              className={cn(
                ...
                {
                  'py-2 px-2 sm:px-4': block.kind === 'code',
                  'py-4 md:p-20 px-3 sm:px-6': block.kind === 'text',
                },
              )}
            >
              <div
